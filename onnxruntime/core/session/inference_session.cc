...
InferenceSession::InferenceSession(const SessionOptions& session_options,
                                   logging::LoggingManager* logging_manager) : InferenceSession(session_options, logging_manager, CreateThreadPool(session_options.session_thread_pool_size)) {
  //Even it's true, the threadpool could be a NULL pointer
